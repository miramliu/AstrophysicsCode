'''This is a cleaned up version of RayTraceFunDetTest.py last used in Detector/TESTING. It has also been shortened to ONLY include the functions that are necessary FOR THE FINAL SIMULATION, rather than ones that were used when building this. Mira'''
import numpy as np
import numpy
...
def CreateRay3D(): 
    ...
    Ray = [thet1,1.0,sourcepoint,v,0]
    return Ray
'''creates a SOURCE OF INITIAL RAYS, with rays defined by point and vector, arbitrary polarization, and distance travelled''' 
