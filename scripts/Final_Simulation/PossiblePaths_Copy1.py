...
'''DONT KNOW WHY but including this here because not importing correctly?'''
...
''' All those below require the position of the mirror (as an origin)'''
